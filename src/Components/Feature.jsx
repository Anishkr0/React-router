    ...
    return (
        ...
        <div class="grid lg:grid-cols-2 items-center gap-10 my-4 bg-white lg:max-w-5xl max-w-xl mx-auto font-[sans-serif] p-4">
            <div class="max-lg:text-center">
                <h2 class="text-gray-800 text-4xl max-sm:text-2xl font-extrabold mb-6">A better way to find plan  more engaging content</h2>
                <p class="text-gray-600 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit. Eu eu quis anim aute.</p>
                <button type="button" class="text-gray-800 border px-4 py-2.5 rounded-md tracking-wide flex items-center text-sm mt-6 hover:bg-gray-50 max-lg:mx-auto">
                    Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-2"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
                </button>
            </div>
            ...
            <div class="grid sm:grid-cols-2 gap-2 mx-auto w-full">
                <div class="text-center hover:shadow-md transition-all duration-300 rounded-xl p-6 w-full">
                    ...
                    <h3 class="text-gray-800 text-base font-bold mt-4 mb-2">Customization</h3>
                    <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm hover:underline">Learn more</a>
                </div>
                ...
                <div class="text-center hover:shadow-md transition-all duration-300 rounded-xl p-6 w-full">
                    ...
                    <h3 class="text-gray-800 text-base font-bold mt-4 mb-2">Security</h3>
                    <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm hover:underline">Learn more</a>
                </div>
                ...
                <div class="text-center hover:shadow-md transition-all duration-300 rounded-xl p-6 w-full">
                    ...
                    <h3 class="text-gray-800 text-base font-bold mt-4 mb-2">Support</h3>
                    <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm hover:underline">Learn more</a>
                </div>
                ...
                <div class="text-center hover:shadow-md transition-all duration-300 rounded-xl p-6 w-full">
                    ...
                    <h3 class="text-gray-800 text-base font-bold mt-4 mb-2">Performance</h3>
                    <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm hover:underline">Learn more</a>
                </div>
